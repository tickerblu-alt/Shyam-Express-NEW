...
// 2.5 Storyline Slide
export function StorylineSlide({ images, onUploadImage, onResetImage }: SlideProps) {
  const solutions = [
    {
      num: "01",
      title: "Operation Open Gyan",
      tagline: "Against Mafia Giri",
      desc: "Full premium course broadcast entirely free, transforming students themselves into co-teachers to break the ₹2 Lakh paywall.",
      icon: <Tv className="w-4 h-4 text-[#FFD978]" />
    },
    {
      num: "02",
      title: "Satya Patra",
      tagline: "Against Paper Leaks",
      desc: "A QR-coded, public blockchain question bank. Every single paper copy is traceable, making anonymous leaks mathematically impossible.",
      icon: <ShieldCheck className="w-4 h-4 text-[#FFD978]" />
    },
    {
      num: "03",
      title: "Sahyog Circle",
      tagline: "Against Student Despair",
      desc: "Daadi's kitchen becomes a 24x7 refuge. No student studies alone after 8 PM—a holistic ecosystem on how to navigate failure safely.",
      icon: <Users className="w-4 h-4 text-[#FFD978]" />
    },
    {
      num: "04",
      title: "HKLC 2.0",
      tagline: "Problem-Solving Pedagogy",
      desc: "Moving from rote memorization to active teaching, intense public debating, and solving real-world challenges: Padhao, Samjhao, Ladwao.",
      icon: <Zap className="w-4 h-4 text-[#FFD978]" />
    }
  ];

  return (
    <div className="slide w-full h-full bg-[#150D0D] relative overflow-hidden flex max-w-[100vw]">
      {/* Background gradients for rich cinematic texture */}
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(circle at 10% 20%, #4A0A0A 0%, rgba(15, 3, 3, 0.99) 70%), radial-gradient(circle at 90% 80%, rgba(184,134,11,0.12) 0%, transparent 60%)`
        }}
      />
      <div className="absolute inset-0 mandala opacity-15 select-none pointer-events-none" />

      <div className="relative w-full max-w-[1240px] mx-auto px-6 md:px-12 pt-6 pb-24 md:py-8 flex flex-col justify-start md:justify-center overflow-y-auto overflow-x-hidden h-full z-10">
        <SectionBadge>The Storyline</SectionBadge>
        
        <div className="mt-1 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="serif text-[28px] md:text-[38px] font-extrabold text-[#FFD978] uppercase tracking-wide leading-tight">
              SHYAM EXPRESS - Haare Ka Sahara
            </h1>
            <p className="text-[12.5px] md:text-[14px] text-white/60 max-w-[800px] mt-1 italic">
              In 2027 Delhi, the HKLC exam is a commercial cartel of fear and ₹2 Lakh fees. This is the narrative of a leaking-roof library, five rejects, and a parallel live broadcast that derailed an empire.
            </p>
          </div>
          <div className="text-[10px] tracking-widest text-[#FFD978] font-mono bg-[#4A0A0A]/60 px-3 py-1.5 rounded-full border border-[#B8860B]/30 font-bold self-start lg:self-auto uppercase">
        ...
        <div className="mt-6 grid lg:grid-cols-12 gap-6 items-start">
          ...
          {/* LEFT COLUMN: THE SAGA & CLIMAX */}
          <div className="lg:col-span-6 space-y-5">
            
            {/* Act 1: The Setup */}
            <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-white/10 transition duration-300">
              <div className="flex items-center gap-2 mb-2.5">
                <span className="text-[10px] font-mono text-[#FFD978] font-bold px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20">ACT I</span>
                <h3 className="text-[13px] uppercase tracking-widest font-extrabold text-white">
                  The Cartel vs. India's Sahara
                </h3>
              </div>
              <p className="text-[12.5px] leading-relaxed text-white/75">
                Two rival coaching mafias—<strong className="text-[#FFD978]">Bansal Classes</strong> and <strong className="text-[#FFD978]">Verma Vision</strong>—control questions, toppers, and fear. 
                Prof. S. Khatu (32), operating a leaking-roof library called <span className="italic">India's Sahara</span>, selects <strong className="text-white">five rejects</strong> who have been written off:
              </p>
              
              {/* The Five Rejects Grid */}
              <div className="mt-3.5 grid grid-cols-5 gap-2 text-center">
                {[
                  { n: "Ananya", d: "UPSC Dream" },
                  { n: "Meher", d: "The Voice" },
                  { n: "Faizan", d: "Leak Victim" },
                  { n: "Rohan", d: "Anxiety" },
                  { n: "Guddi", d: "Basti Pride" }
                ].map((item, idx) => (
                  <div key={idx} className="p-2 rounded-lg bg-black/40 border border-white/5">
                    <div className="text-[10.5px] font-bold text-white truncate">{item.n}</div>
                    <div className="text-[8px] text-[#FFD978]/70 tracking-tighter mt-0.5 truncate">{item.d}</div>
                  </div>
                ))}
              </div>
              <p className="text-[12px] leading-relaxed text-white/75 mt-3">
                From a railway retiring room, daily at 9 PM, they launch a free YouTube channel: <strong className="text-[#FFD978] font-semibold">SHYAM EXPRESS</strong>, teaching students how to dismantle and survive the exam machine.
              </p>
            </div>

            {/* Act 2: The Rebuild & Retaliation */}
            <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-white/10 transition duration-300">
              <div className="flex items-center gap-2 mb-2.5">
                <span className="text-[10px] font-mono text-[#FFD978] font-bold px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20">ACT II</span>
                <h3 className="text-[13px] uppercase tracking-widest font-extrabold text-white">
                  The Rebuild & The Retaliation
                </h3>
              </div>
              <p className="text-[12.5px] leading-relaxed text-white/75">
                Rather than memorizing syllabus answers, the crew rolls out <strong className="text-[#FFD978]">4 radical systemic solutions</strong> (Open Gyan, Satya Patra, Sahyog Circle, and HKLC 2.0). As the channel's viral influence skyrockets, the threatened coaching giants unite to strike-ban their stream and leak the final paper a night early to force their downfall.
              </p>
            </div>

            {/* Act 3: The Climax */}
            <div className="p-5 rounded-2xl bg-[#4A0A0A]/30 border border-[#B8860B]/30 hover:border-[#B8860B]/50 transition duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFD978]/5 rounded-full blur-2xl pointer-events-none" />
              <div className="flex items-center gap-2 mb-2.5 relative z-10">
                <span className="text-[10px] font-mono text-[#FFD978] font-bold px-2 py-0.5 rounded bg-[#B8860B]/20 border border-[#B8860B]/40">ACT III</span>
                <h3 className="text-[13px] uppercase tracking-widest font-extrabold text-[#FFD978]">
                  The 3 AM Diya & The Parallel Platform Live
                </h3>
              </div>
              <p className="text-[12.5px] leading-relaxed text-white/85 relative z-10">
                The institutes combine to ban his channel and leak the final HKLC paper a night early to sabotage his students. 
                A student collapses. The batch shatters. At 3 AM, Daadi lights a diya before Khatu Shyam Ji and whispers:
              </p>
              <div className="my-3 pl-3 border-l-2 border-[#FFD978] text-[13px] italic text-[#FFD978]/90 font-serif leading-relaxed">
                "Haare ka Sahara, Khatu Shyam Hamara. Tu witness nahi, saarthi ban."
              </div>
              <p className="text-[12px] leading-relaxed text-white/80">
                Instead of retreating, Khatu conducts a live parallel exam directly from a railway platform with <strong className="text-white">50,000 students online</strong>, using the leaked paper itself as <span className="text-[#FFD978]">Question Zero</span> to expose the entire mafia. 
                The official exam is cancelled, and the true train of learning departs.
              </p>
            </div>

          </div>

          {/* RIGHT COLUMN: THE 4 SOLUTIONS & VISUAL */}
          <div className="lg:col-span-6 space-y-4">
            
            <div className="text-[11px] tracking-[0.2em] uppercase text-white/40 font-bold mb-1">
              Prof. S. Khatu's 4 Pedagogical Solutions
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {solutions.map((s, idx) => (
                <div 
                  key={idx} 
                  className="p-4 rounded-xl border bg-black/30 border-white/5 hover:border-white/10 transition-all"
                >
                  <div className="flex items-center gap-2.5 mb-1.5">
                    <div className="w-6 h-6 rounded-full bg-[#4A0A0A] border border-[#B8860B]/20 flex items-center justify-center shrink-0">
                      {s.icon}
                    </div>
                    <div>
                      ...
                      <div className="text-[8.5px] text-[#FFD978] font-mono tracking-wider uppercase">
                        {s.tagline}
                      </div>
                    </div>
                  </div>
            ...
            {/* Custom Atmospheric Visual */}
            <div className="pt-2">
              <SlideImageZone
                slotId="slide_storyline_image"
                images={images}
                onUploadImage={onUploadImage}
                onResetImage={onResetImage}
                aspectClass="aspect-[16/7]"
                defaultLabel="Storyline Atmosphere (e.g. Railway Station at night, leaking-roof library)"
                defaultImage={slide1Image}
              />
            </div>
